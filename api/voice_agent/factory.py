...
def _behavior_rules_section() -> str:
    ...
    return (
        ...
        "  - Before `verify_caller_identification`: ask for the LAST NAME and "
        "the last 4 phone digits together, then confirm both in one readback "
        "— spell the surname letter-by-letter and read the four digits. Do "
        ...
        "cancelled.\n"
        "  - Before `confirm_appointment`: read back which appointment is "
        "being confirmed (type, day, time) and get a clear yes.\n"
